...
\addplot [color=green] table {fig/numerical/xhat.txt}; \addlegendentry{$\xhat$}
\addplot [color=blue] table {fig/numerical/y.txt}; \addlegendentry{$\y$}
...
xmajorgrids,ymajorgrids]
\addplot [color=blue] table {fig/numerical/eomega.txt};
\end{axis}\end{tikzpicture}
